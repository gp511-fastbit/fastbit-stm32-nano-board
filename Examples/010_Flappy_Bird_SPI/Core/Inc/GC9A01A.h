...
#define GC9A01A_DC_CMD     		HAL_GPIO_WritePin(LCD_DCX_GPIO_Port, LCD_DCX_Pin, GPIO_PIN_RESET)
#define GC9A01A_DC_DATA    		HAL_GPIO_WritePin(LCD_DCX_GPIO_Port, LCD_DCX_Pin, GPIO_PIN_SET)
...
/********************** SPI handle **********************/
extern SPI_HandleTypeDef hspi1; // SPI1 handle defined in main.h or elsewhere
